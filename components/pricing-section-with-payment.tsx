      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center text-center mb-12">
          ...
          <p className="text-zinc-400 max-w-2xl">
            {
              "You can use our platform for free with 3 clients, forever. No hidden fees, no limitations (other than the 3 clients). Paying means you get everything but with unlimited clients. The world is yours."
            }
          </p>
        </div>
                ...
                >
                  <CardHeader>
                    <div className="flex justify-between items-center">
                      ...
                      <span className="px-3 py-1 text-xs font-semibold bg-juice text-black rounded-full">POPULAR</span>
                    </div>
                    <div
                      className={`mt-4 flex items-baseline text-5xl font-extrabold ${isCoach ? "text-black" : "text-white"}`}
                    >

...
export const metadata: Metadata = {
  ...
  metadataBase: new URL(process.env.NEXT_PUBLIC_APP_URL || 'https://juice-website.vercel.app'),
  alternates: {
...
const structuredData = {
  ...
  "mainEntity": {
    ...
    "offers": {
      "@type": "Offer",
      "description": "Professional website builder for personal trainers",

...
export const metadata: Metadata = {
  title: 'Personal Trainer Website Builder | Create Your Professional Fitness Website',
  description: 'Build a stunning personal trainer website in minutes. No coding required. Professional templates, client management, and booking system included.',
  keywords: 'personal trainer website, fitness website builder, trainer website template, fitness business website',
  authors: [{ name: 'Juice' }],
  creator: 'Juice',
  publisher: 'Juice',
  robots: {
  ...
  openGraph: {
    ...
    title: 'Personal Trainer Website Builder | Professional Fitness Websites',
    description: 'Create a professional personal trainer website that attracts clients and grows your fitness business. Quick setup, no coding required.',
    siteName: 'Juice',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'Personal Trainer Website Builder',
    description: 'Build your professional fitness website in minutes. No coding required.',
